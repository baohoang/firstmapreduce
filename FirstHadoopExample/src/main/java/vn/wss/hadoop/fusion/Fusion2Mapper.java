...
public class Fusion2Mapper extends MapReduceBase implements
	...
	public void map(PairWritable arg0, IntWritable arg1,
		...
		LongWritable key = new LongWritable(arg0.getbID());
		PrefWritable pref = new PrefWritable(arg0.getaID(), arg1.get());
